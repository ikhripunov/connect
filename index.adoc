...
The repo for this Documentation can be found on Github: https://github.com/ClearPointNZ/connect image::https://api.travis-ci.org/ClearPointNZ/connect.svg[Build Status]
